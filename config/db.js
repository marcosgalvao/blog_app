if(process.env.NODE_ENV == 'production'){
    ...
    // module.exports = {mongoURI: 'mongodb+srv://marcosgalvaotecnologia:Mag_23degiu@cluster0.nv1wy.mongodb.net/mgtecdb?retryWrites=true&w=majority'}
   
   // mongodb+srv://<username>:<password>@cluster0.nv1wy.mongodb.net/myFirstDatabase?retryWrites=true&w=majority
